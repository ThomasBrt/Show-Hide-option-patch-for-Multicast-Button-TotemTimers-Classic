...
if LE_EXPANSION_LEVEL_CURRENT > LE_EXPANSION_BURNING_CRUSADE then
    TotemTimers.options.args.timers.args.multispell = {
        order = 3,
        type = "toggle",
        name = L["Show Multicast Button"],
        desc = L["Shows button for Call of Elements etc."],
        set = function(info, val)
            TotemTimers.ActiveProfile.MultiCastDisplay = val -- New option in Timers tab : Multicast Button Display while active - Memø 24012023
        ...
        get = function(info)
            return TotemTimers.ActiveProfile.MultiCastDisplay
            --return TotemTimers.ActiveProfile.MultiCast
        end,
    }
end
