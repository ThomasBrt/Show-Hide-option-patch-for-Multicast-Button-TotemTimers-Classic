...
if WOW_PROJECT_ID > WOW_PROJECT_CLASSIC then
    ...
    if LE_EXPANSION_LEVEL_CURRENT > LE_EXPANSION_BURNING_CRUSADE then
        ...
        -- Setting new value to Multicast Button Display while active - Memø 24012023
        SettingsFunctions.MultiCastDisplay = function(value)
            _G["TotemTimers_MulticastDisplayActive"] = value
