...
-- Var init and use of the MultiCastDisplay setting - Memø 24012023
local MulticastDisplayActive = TotemTimers.ActiveProfile.MultiCastDisplay -- false by default
_G["TotemTimers_MulticastDisplayActive"] = MulticastDisplayActive
...
-- Function to set the Multicast Button Display while active - Memø 24012023
function TotemTimers.SetMulticastDisplay()
